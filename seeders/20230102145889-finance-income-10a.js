...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const startDate = moment('2023-10-01', 'YYYY-MM-DD');
    const startTimestamp = moment('2023-10-01 23:15:41.459+05:45', 'YYYY-MM-DD HH:mm:ss.SSSZ');

    // Generate and insert the finance entries with sequential date and timestamp
    const randomFinances = [];
    for (let i = 0; i < 10; i++) { // Change to the number of entries you want
      const financeEntry = {
        ...baseFinanceEntry,
